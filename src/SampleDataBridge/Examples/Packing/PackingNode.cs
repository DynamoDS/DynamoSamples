...
namespace SampleDataBridge.Examples.Packing
{
    /// <summary>
    ...
    {
        protected const string TypeDefinitionPortName = "Type";
        ...
        public PackingNode()
        {
            InPorts.Add(new PortModel(PortType.Input, this, new PortData(TypeDefinitionPortName, "TypeDefinition as a String")));
